            ...
            <div className="p-4 bg-gray-50 border-t border-gray-200">
              ...
              <div className="text-gray-700">
                ...
                <ul className="list-disc list-inside space-y-0.5 text-sm text-gray-600">
                  ...
                  <li>【反馈记录】的操作中，门店工作人员处理这条反馈后点击【已处理】按钮，反馈状态会自动改为【已处理】，按钮变成【未处理】；点击【未处理】按钮，反馈状态会自动改为【未处理】，按钮变成【已处理】</li>
                  <li>点击【查看】按钮，打开反馈详情弹窗，如有图片，会显示在弹窗中，若无图片，图片一栏显示为无</li>
                  <li>在【设置】中，可设置反馈方式，通过【微信/企微客服】、【留言反馈】的开关控制C端小程序【联系客服】和【我要反馈】卡片的显隐</li>
                  <li>交互提示：【设置】页面的原型在配置之后可更新C端小程序【客服与反馈】页面，请在配置之后点击【保存】按钮，重新进入小程序的【客服与反馈】页面，即可看到新设置的效果。</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="p-4 bg-gray-50 border-t border-gray-200">
              ...
              <div className="text-gray-700">
                ...
                <ul className="list-disc list-inside space-y-0.5 text-sm text-gray-600">
                  ...
                  <li>限制二维码图片的最高高度，为页面高度的1/2，限制图片的宽度（可参照当前的宽度），当图片高度低于页面高度1/2时，图片自适应宽度；当图片高度超过1/2时，图片自适应高度</li>
                  <li>上传图片限制为3张</li>
                </ul>
              </div>
            </div>
